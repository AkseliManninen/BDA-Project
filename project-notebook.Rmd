...
$\sigma_j ∼ Inv-\chi^2(0, 1)$ 

$y_{ij}|\theta_j, \sigma_j ∼ N(\theta_j, \sigma_j^2)$
...
$y_{i}|\theta, \sigma ∼ N(\theta, \sigma^2)$
...
$\sigma_P ∼ Inv-\chi^2(0, 1)$


$\theta_j |\theta_P, \sigma_P^2 ∼ Normal(\theta_P, \sigma_P^2)$


$\sigma ∼ Normal(0, 200)$


$y_{ij} |\theta_j ∼ N(\theta_j, \sigma^2)$
