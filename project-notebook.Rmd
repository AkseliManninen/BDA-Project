...
**TARKISTETTAVA: The selected categorical variables were: URBAN, DOCTORAL, MASTER, PRIVATE.**

## Phase 3 - Feature selection with stepwise regression

**TARKISTETTAVA PITÄÄKÖ ALLAOLEVA TEKSTI PAIKKANSA, ETENKIN KUN TAITAA TULLA MUUTOKSIA MALLEIHIN VIELÄ**
...
The stepwise regression suggested using all of the variables, except DOCTORAL. The output of the stepwise regression can be found in the Appendix. Because stepwise regression suggested leaving out DOCTORAL, for the sake of consistency we decided to also leave out MASTER as it was a the middle level in our institutional classifications and wouldn't have made much sense on its own. The stewpise regression was run again after removing MASTER and DOCTORAL and all the rest variables were suggested.
...
6 & URBAN & binary & Urban or rural area \\
7 & PRIVATE & binary & Private or public school \\
\end{tabular}
$$
MD_EARN_WNE_P10 ~ SAT_ALL + MD_FAMINC + COSTT4_A + 
    POVERTY_RATE + URBAN + PRIVATE + MASTER
