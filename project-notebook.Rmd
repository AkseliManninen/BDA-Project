...
From the numerical variables, First Gen was eliminated because it was highly
correlated with MD_Faminc and MD_Faminc. MD_Faminc was selected because
it had higher correlation with the dependant variable, and there seemed to
be linear dependecy based on the plotted data points.

Female was excluded because there did not seem to be dependency between
the dependent variable and Female. Also, the aboslut value 
of correlation was low.

First gen was excluded because...

Pct_white was eliminated, because it had little correlation with the dependent
variable.

Debt_mdn_supp was excluded because...

C150_4 was excluded because..

Costt4_a was included because...

Poverty_rate was included because...

Unemp_was excluded because...

Married was excluded because...
...
Bachelor vs. Master vs Doctoral


After the second phase the selected variables were: SAT_ALL, MD_Faminic, Age_entry, Costt4_a, Poverty_rate, (rural vs. city, public vs. private, kandi vs. maisteri vs. doctorla (fixaa nää oikeiks)) 
