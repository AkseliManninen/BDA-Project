...
in the United States / Median SAT Score (math and writing).

mu = 31 000 / (523 + 528/2) = 43.2...

TODO: Add sources to the end and to the text:
...
- Tarkista, oliko niko laskenut tulokset yhteen, vai keskiarvon tuloksista.
Aikaisemmin tässä tiedostossa puhutaan keskiarvoista, joten fixaa tarvittessa.
...
data {
  ...
  vector[N] SAT_ALL; // real valued observations
  vector[N] AGE_ENTRY; 
  vector[N] y;
}
...
transformed parameters {
  vector[N] mu;
  mu = alpha + beta_SAT_ALL * SAT_ALL + beta_AGE_ENTRY * AGE_ENTRY;
}
