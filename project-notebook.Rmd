...
$y_{ij}|mu_j, sigma_j ∼ N(mu_j, sigma_j^2)$

where $mu_j = a_j +\textbf{X}\textbf{B}_j$
...
$y_{i}|mu, sigma ∼ N(mu, sigma^2)$

where $mu = a +\textbf{X}\textbf{B}$
...
$y_{ij} |mu_j ∼ N(mu_j, sigma^2)$

where $mu_j |mu_P, sigma_P^2 ∼ N(mu_P, sigma_P^2)$
...
Based on $\hat{K}$ the predictions ara ... too optimistic/reliable?
